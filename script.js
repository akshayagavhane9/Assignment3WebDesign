...
window.onload = function() {
  var fullName = "Akshaya Gavhane"; // Replace with your actual name
  var nuid = "002812638"; // Replace with your actual NUID
  document.getElementById("userinfo").innerHTML = "Name: " + fullName + "<br>NUID: " + nuid;
};
...
function addNewStudent() {
  ...
  try {
  var rows1 = document.getElementById("table").rows;
  var latestIndex;
  if (rows.length > 1) {
  ...
  tbodyRef.appendChild(tdNode);
    ...
    // Handle talert("Error adding record. Please try again.");he error appropriately, such as logging it or showing a user-friendly message.
  }
...
function deleteRow(rowObject) {
  ...
  document.getElementById("table").deleteRow(tr.rowIndex + 1);
